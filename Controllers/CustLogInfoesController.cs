...
namespace CustomSupportLogger.Controllers
{
    ...
    {
        private readonly CustomSupportDbContext _context;

        public CustLogInfoesController(CustomSupportDbContext context)
        {
            _context = context;
        }
        ...
        {
            var customSupportDbContext = _context.CustLogInfos.Include(c => c.User);
            return View(await customSupportDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CustomSupportDbContext.CustLogInfos'  is null.");
            }
            var custLogInfo = await _context.CustLogInfos.FindAsync(id);
            if (custLogInfo != null)
            {
